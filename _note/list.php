...
<div id="wrapper2">
	...
	<div class='wrap'>
		...
		<div id='list_h'>공지사항&nbsp;<span class="list_h2">Notice</span></div>
		
			<form  name="board_form" method="post" action="list.php?table=<?=$table?>&mode=search"> 
			<div id="list_search">
				<div id="list_search1" class="f_l">▷ 총 <?= $total_record ?> 개의 게시물이 있습니다.  </div>
				<div id="list_search2" class="f_r">
					<select name="find">
	...
	<?		
	   ...
	   { 
		  $result->data_seek($i);  //디비 포인터 이동..찾기 힘드어따ㅠㅠ         
	...
	<? 
		if(!empty($_SESSION['userid'])&&($_SESSION['usercheck']=='1'))//공지사항글쓰기는 관리자만 보기가능!
		{
			?>
